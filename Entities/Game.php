...
class Game {
     ...
     * @return bool
     */
    private function isSpare($firstInFrame)
    {
     ...
     * @return bool
     */
    private function isStrike($firstInFrame)
    {
     ...
     * @return integer
     */
    private function nextTwoBallsForStrike($firstInFrame) {
     ...
     * @return mixed
     */
    private function nextBallForSpare($firstInFrame)
    {
     ...
     * @return mixed
     */
    private function twoBallsInFrame($firstInFrame)
    {
